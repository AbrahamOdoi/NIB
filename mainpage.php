	...
	<body>
		<div id='page' data-role='page'>
			...
			<div id='content' data-role='content'>
				...
				<p>
					<div style="background: url('images/NIB 2.jpg');height: 100px;background-size: 80%;background-repeat:no-repeat; width:100px; "></div>
					<div  style='text-align:left; font-family: Arial, Helvetica, sans-serif;font-size: 10px; '>

						&copy; 2013 NIB. Copyright 2013 NIB.
						<br />
						NIB All rights reserved
						NIB Group authorized financial services and registered credit provider.
			...
			<div id="lower">
				...
				background-size: 300%; color: white; display: none; ">
					As the Corporate Social Responsibility arm of the NIB, NIB Foundation is committed to the
				...
				background-repeat: no-repeat;font-family: Arial, Helvetica, sans-serif;font-size: 10px;
				background-size: 300%; color: white; display: none;">
					The NIB mobile banker application is meant to provide clients of NIB with most of the basic services offered by the bank
					through hand held devices. This service is provided by NIB and powered by NALO SOLUTIONS.
				</p>
